            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="row">
                     <div class="col">
                        <center>
                            <img Height="150px" Width="100px" src="book_inventory/books1.png" />
                        </center>
                     </div>
                  </div>
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        ...
                        <div class="form-group">
                           <div class="input-group">
                              <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Member ID" required></asp:TextBox>
                               <asp:Button class="btn btn-outline-primary" ID="Button5" runat="server" Text="Go" OnClick="Button4_Click" />
                     ...
                     <div class="col-md-6">
                        ...
                        <div class="form-group">
                           <asp:DropDownList class="form-control" ID="DropDownList4" runat="server">
                              <asp:ListItem Text="--Select--" Value="--Select--" />
                               <asp:ListItem disabled="true">Computer Science And Technology</asp:ListItem>
                               <asp:ListItem>CST-1st Sem</asp:ListItem>
                               <asp:ListItem>CST-2nd Sem</asp:ListItem>
                               <asp:ListItem>CST-3rd Sem</asp:ListItem>
                               <asp:ListItem>CST-4th Sem</asp:ListItem>
                               <asp:ListItem>CST-5th Sem</asp:ListItem>
                               <asp:ListItem>CST-6th Sem</asp:ListItem>
                               <asp:ListItem disabled="true">Civil Engineering</asp:ListItem>
                               <asp:ListItem>CE-1st Sem</asp:ListItem>
                               <asp:ListItem>CE-2nd Sem</asp:ListItem>
                               <asp:ListItem>CE-3rd Sem</asp:ListItem>
                               <asp:ListItem>CE-4th Sem</asp:ListItem>
                               <asp:ListItem>CE-5th Sem</asp:ListItem>
                               <asp:ListItem>CE-6th Sem</asp:ListItem>
                               <asp:ListItem disabled="true">Electrical Engineering</asp:ListItem>
                               <asp:ListItem>EE-1st Sem</asp:ListItem>
                               <asp:ListItem>EE-2nd Sem</asp:ListItem>
                               <asp:ListItem>EE-2nd Sem</asp:ListItem>
                               <asp:ListItem>EE-4th Sem</asp:ListItem>
                               <asp:ListItem>EE-5th Sem</asp:ListItem>
                               <asp:ListItem>EE-6th Sem</asp:ListItem>
                           </asp:DropDownList>
                        </div>
                      </div>
                   </div>   
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <label>Cost of Book</label>
                        <div class="form-group">
                           <asp:TextBox CssClass="form-control" ID="TextBox10" runat="server" placeholder="Per Unit" TextMode="Number"></asp:TextBox>
                        </div>
                     </div>
                     <div class="col-md-4">
                        <label>Pages</label>
                  ...
                  <p></p>
                  <div class="row">     
                     <div class="col-4 form-group d-grid gap-2 mx-auto">
                        <asp:Button ID="Button1" class="btn btn-outline-success" runat="server" Text="Add" OnClick="Button1_Click"/>
                     </div>
                     <div class="col-4 form-group d-grid gap-2 mx-auto">
                        <asp:Button ID="Button3" class="btn btn-outline-warning" runat="server" Text="Update" OnClick="Button3_Click"/>
                     </div>
                     <div class="col-4 form-group d-grid gap-2 mx-auto">
