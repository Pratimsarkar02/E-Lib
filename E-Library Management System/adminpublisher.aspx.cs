...
{
    public partial class adminpublishermanagemenr : System.Web.UI.Page
    {
        ...
        protected void Button2_Click1(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('This Publisher ID already exists with other Publisher Name');</script>");
            }
            else
            {
                addNewPublisher();
        ...
        void getPublisherByID()
        {
            try
            {
                ...
                if (dt.Rows.Count >= 1)
                {
                    TextBox1.Text = dt.Rows[0]["publisher_id"].ToString();
        ...
        void deletePublisher()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('Publisher Has Been Deleted Successfully');</script>");
                clearForm();
                GridView1.DataBind();
        ...
        void updatePublisher()
        {
            try
            {
                ...
                cmd.ExecuteNonQuery();
                con.Close();
                Response.Write("<script>alert('Publisher Has Been Updated Successfully');</script>");
                clearForm();
                GridView1.DataBind();
            }
            catch (Exception ex)
