...
namespace E_Library_Management_System
{
    public partial class userprofile : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                Response.Write("<script>alert('Your Session has been expired, Login again')</script>");
        ...
        void updateUserPersonalDetails()
        {
            ...
            try
            {
                ...
                if (result > 0)
                {
                    ...
                    Response.Write("<script>alert('Your details has been updated successfully');</script>");
                    getUserPersonalDetails();
                    getUsersBookData();
                }
                else
        ...
        void getUserPersonalDetails()
        {
            try
            {
                ...
                DropDownList2.SelectedValue = dt.Rows[0]["department"].ToString().Trim();
                DropDownList3.SelectedValue = dt.Rows[0]["year"].ToString().Trim();
                DropDownList4.SelectedValue = dt.Rows[0]["semester"].ToString().Trim();
