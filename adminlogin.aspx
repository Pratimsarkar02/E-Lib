...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server" Visible="True">
</asp:Content>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col">
                                    <center>
                                        <img width="150px" src="imgs/useradmin.png" />
                                    </center>
                                </div>
                            </div>
                            <div class="row">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <div class="form-group">
                                        <asp:TextBox CssClass="form-control" ID="TextBox1" runat="server" placeholder="Admin ID" required></asp:TextBox>
                                    </div>
